...
function percent() {
  // 先让菜单栏消失
  if (typeof rmf !== 'undefined' && typeof rmf.showRightMenu === 'function') {
  ...
  let a = document.documentElement.scrollTop || document.body.scrollTop, // 卷去高度
  ...
  if (result < 95) { // 如果阅读进度小于95% 就显示百分比
    if (btn && btn.childNodes[0]) btn.childNodes[0].style.display = 'none';
    if (btn && btn.childNodes[1]) {
      btn.childNodes[1].style.display = 'block';
      btn.childNodes[1].innerHTML = result + '<span>%</span>';
    }
  } else { // 如果大于95%就显示回到顶部图标
    if (btn && btn.childNodes[1]) btn.childNodes[1].style.display = 'none';
    if (btn && btn.childNodes[0]) btn.childNodes[0].style.display = 'block';
  }
}
/* 阅读进度 end */
...
$.ajax({
  ...
  data: {
    key: 'XJMBZ-CLVCC-QXZ2Q-A7XQF-HPNE6-M2BR7',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(112.93,28.23, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by 鲸落辰空 %c 你正在访问鲸落辰空の小窝🍉",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 鲸落辰空") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('鲸落辰空的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
<div class="bgbox">
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/BigKnight53/gallery/raw/master/background/example.webp)" class="imgbox" onclick="changeBg('url(https://gitee.com/BigKnight53/gallery/raw/master/background/example.webp)')"></a>
...
{% folding cyan, 查看风景背景 %}
<div class="bgbox">
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.fomal.cc/img/fj1.webp)" class="imgbox" onclick="changeBg('url(https://source.fomal.cc/img/fj1.webp)')"></a>
...
{% folding cyan, 查看萌宠背景 %}
<div class="bgbox">
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://source.fomal.cc/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://source.fomal.cc/img/mc1.webp)')"></a>
...
<div class="bgbox">
<a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://gitee.com/BigKnight53/gallery/raw/master/mobilenight-bg.webp)" class="pimgbox" onclick="changeBg('url(https://gitee.com/BigKnight53/gallery/raw/master/mobilenight-bg.webp)')"></a>
...
<p><center>
<input type="text" id="pic-link" size="70%" maxlength="1000" placeholder="请输入有效的图片链接，如 https://gitee.com/BigKnight53/gallery/raw/master/background/example.webp">
</center></p>
<p><center>
